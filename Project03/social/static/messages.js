/* ********************************************************************************************
   ...
   ********************************************************************************************
   */
function subResponse(data,status) {
    if (status == 'success') {
	location.reload();
    }
    else{
...
/* ********************************************************************************************
   ...
   ********************************************************************************************
   */
function subLikeResponse(data,status) {
    if (status == 'success') {
	$("#"+data.postID).prop('disabled', true);
	$("#"+data.postID).removeClass("like-button");
    	location.reload();
    }
    else{
    	alert('failed to submit like' + status);
    }
}
